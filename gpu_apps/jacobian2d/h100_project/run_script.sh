...
if [[ "${CXXFLAGS}" == *"-DPOWER_PROFILE"* ]]; then
    ...
    parameter_sets=(
            ...
            "400,300,60000,1,1"
            "400,400,60000,1,1"
            "100,100,60000,100,100"
            "200,100,60000,100,100"
            "200,200,60000,100,100"
            "300,150,60000,100,100"
            "300,300,60000,100,100"
            "400,200,60000,100,100"
            "400,300,60000,100,100"
            "400,400,60000,100,100"
    ...
    parameter_sets=(
            ...
            "400,300,60000,1,20"
            "400,400,60000,1,20"
            "100,100,60000,100,200"
            "200,100,60000,100,200"
            "200,200,60000,100,200"
            "300,150,60000,100,200"
            "300,300,60000,100,200"
            "400,200,60000,100,200"
            "400,300,60000,100,200"
            "400,400,60000,100,200"
            # Add more parameter sets here as needed
        )
fi
