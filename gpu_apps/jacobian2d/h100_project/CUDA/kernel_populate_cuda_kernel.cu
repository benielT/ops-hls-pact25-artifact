...
//
__constant__ int dims_kernel_populate [1][3];
static int dims_kernel_populate_h [1][3] = {0};
...
int bounds_2_l, int bounds_2_u) {
  ...
  if (n_0 < bounds_0_u && n_1 < bounds_1_u && n_2 < bounds_2_u) {
    ACC<float> u(dims_kernel_populate[0][0], dims_kernel_populate[0][1], u_p + n_0 + n_1 * dims_kernel_populate[0][0] + n_2 * dims_kernel_populate[0][0] * dims_kernel_populate[0][1]);
...
void ops_par_loop_kernel_populate_execute(const char *name, ops_block block, int blockidx_start, int blockidx_end, int dim, int *range, int nargs, ops_arg* args) {
  ...
  #endif
  if (args[0].dat->size[0] != dims_kernel_populate_h[0][0] || args[0].dat->size[1] != dims_kernel_populate_h[0][1] || args[0].dat->size[2] != dims_kernel_populate_h[0][2]) {
