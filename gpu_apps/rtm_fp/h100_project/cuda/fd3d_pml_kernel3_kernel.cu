// Auto-generated at 2025-08-06 23:23:48.400924 by ops-translator

__constant__ int dims_fd3d_pml_kernel3[27][2];
static int dims_fd3d_pml_kernel3_h[27][2] = {{0}};

//  =============
//  User function
//  =============
__device__ void fd3d_pml_kernel3_gpu(const int *dispx, const int *dispy, const int *dispz, const int *idx, const float *dt, const float *scale1, const float *scale2, const ACC<float> &rho, const ACC<float> &mu, ACC<float> &yy_0, ACC<float> &yy_1, ACC<float> &yy_2, ACC<float> &yy_3, ACC<float> &yy_4, ACC<float> &yy_5, const ACC<float> &dyyIn_0, const ACC<float> &dyyIn_1, const ACC<float> &dyyIn_2, const ACC<float> &dyyIn_3, const ACC<float> &dyyIn_4, const ACC<float> &dyyIn_5, const ACC<float> &sum_0, const ACC<float> &sum_1, const ACC<float> &sum_2, const ACC<float> &sum_3, const ACC<float> &sum_4, const ACC<float> &sum_5) {
...
//  ============================
__global__ void ops_fd3d_pml_kernel3(const int arg0, 
const int arg1, 
const int arg2, 
...
int size0, int size1, int size2) {
    ...
    arg7 += idx_x * xstride_7*1 + idx_y * ystride_7*1 * dims_fd3d_pml_kernel3[7][0] + idx_z * zstride_7*1 * dims_fd3d_pml_kernel3[7][0] * dims_fd3d_pml_kernel3[7][1];
    arg8 += idx_x * xstride_8*1 + idx_y * ystride_8*1 * dims_fd3d_pml_kernel3[8][0] + idx_z * zstride_8*1 * dims_fd3d_pml_kernel3[8][0] * dims_fd3d_pml_kernel3[8][1];
    arg9 += idx_x * xstride_9*1 + idx_y * ystride_9*1 * dims_fd3d_pml_kernel3[9][0] + idx_z * zstride_9*1 * dims_fd3d_pml_kernel3[9][0] * dims_fd3d_pml_kernel3[9][1];
    arg10 += idx_x * xstride_10*1 + idx_y * ystride_10*1 * dims_fd3d_pml_kernel3[10][0] + idx_z * zstride_10*1 * dims_fd3d_pml_kernel3[10][0] * dims_fd3d_pml_kernel3[10][1];
    arg11 += idx_x * xstride_11*1 + idx_y * ystride_11*1 * dims_fd3d_pml_kernel3[11][0] + idx_z * zstride_11*1 * dims_fd3d_pml_kernel3[11][0] * dims_fd3d_pml_kernel3[11][1];
    arg12 += idx_x * xstride_12*1 + idx_y * ystride_12*1 * dims_fd3d_pml_kernel3[12][0] + idx_z * zstride_12*1 * dims_fd3d_pml_kernel3[12][0] * dims_fd3d_pml_kernel3[12][1];
    arg13 += idx_x * xstride_13*1 + idx_y * ystride_13*1 * dims_fd3d_pml_kernel3[13][0] + idx_z * zstride_13*1 * dims_fd3d_pml_kernel3[13][0] * dims_fd3d_pml_kernel3[13][1];
    arg14 += idx_x * xstride_14*1 + idx_y * ystride_14*1 * dims_fd3d_pml_kernel3[14][0] + idx_z * zstride_14*1 * dims_fd3d_pml_kernel3[14][0] * dims_fd3d_pml_kernel3[14][1];
    arg15 += idx_x * xstride_15*1 + idx_y * ystride_15*1 * dims_fd3d_pml_kernel3[15][0] + idx_z * zstride_15*1 * dims_fd3d_pml_kernel3[15][0] * dims_fd3d_pml_kernel3[15][1];
    arg16 += idx_x * xstride_16*1 + idx_y * ystride_16*1 * dims_fd3d_pml_kernel3[16][0] + idx_z * zstride_16*1 * dims_fd3d_pml_kernel3[16][0] * dims_fd3d_pml_kernel3[16][1];
    arg17 += idx_x * xstride_17*1 + idx_y * ystride_17*1 * dims_fd3d_pml_kernel3[17][0] + idx_z * zstride_17*1 * dims_fd3d_pml_kernel3[17][0] * dims_fd3d_pml_kernel3[17][1];
    arg18 += idx_x * xstride_18*1 + idx_y * ystride_18*1 * dims_fd3d_pml_kernel3[18][0] + idx_z * zstride_18*1 * dims_fd3d_pml_kernel3[18][0] * dims_fd3d_pml_kernel3[18][1];
    arg19 += idx_x * xstride_19*1 + idx_y * ystride_19*1 * dims_fd3d_pml_kernel3[19][0] + idx_z * zstride_19*1 * dims_fd3d_pml_kernel3[19][0] * dims_fd3d_pml_kernel3[19][1];
    arg20 += idx_x * xstride_20*1 + idx_y * ystride_20*1 * dims_fd3d_pml_kernel3[20][0] + idx_z * zstride_20*1 * dims_fd3d_pml_kernel3[20][0] * dims_fd3d_pml_kernel3[20][1];
    arg21 += idx_x * xstride_21*1 + idx_y * ystride_21*1 * dims_fd3d_pml_kernel3[21][0] + idx_z * zstride_21*1 * dims_fd3d_pml_kernel3[21][0] * dims_fd3d_pml_kernel3[21][1];
    arg22 += idx_x * xstride_22*1 + idx_y * ystride_22*1 * dims_fd3d_pml_kernel3[22][0] + idx_z * zstride_22*1 * dims_fd3d_pml_kernel3[22][0] * dims_fd3d_pml_kernel3[22][1];
    arg23 += idx_x * xstride_23*1 + idx_y * ystride_23*1 * dims_fd3d_pml_kernel3[23][0] + idx_z * zstride_23*1 * dims_fd3d_pml_kernel3[23][0] * dims_fd3d_pml_kernel3[23][1];
    arg24 += idx_x * xstride_24*1 + idx_y * ystride_24*1 * dims_fd3d_pml_kernel3[24][0] + idx_z * zstride_24*1 * dims_fd3d_pml_kernel3[24][0] * dims_fd3d_pml_kernel3[24][1];
    arg25 += idx_x * xstride_25*1 + idx_y * ystride_25*1 * dims_fd3d_pml_kernel3[25][0] + idx_z * zstride_25*1 * dims_fd3d_pml_kernel3[25][0] * dims_fd3d_pml_kernel3[25][1];
    arg26 += idx_x * xstride_26*1 + idx_y * ystride_26*1 * dims_fd3d_pml_kernel3[26][0] + idx_z * zstride_26*1 * dims_fd3d_pml_kernel3[26][0] * dims_fd3d_pml_kernel3[26][1];

    if(idx_x < size0 && idx_y < size1 && idx_z < size2) {

        const ACC<float> argp7(dims_fd3d_pml_kernel3[7][0], dims_fd3d_pml_kernel3[7][1], arg7);
        const ACC<float> argp8(dims_fd3d_pml_kernel3[8][0], dims_fd3d_pml_kernel3[8][1], arg8);
        ACC<float> argp9(dims_fd3d_pml_kernel3[9][0], dims_fd3d_pml_kernel3[9][1], arg9);
        ACC<float> argp10(dims_fd3d_pml_kernel3[10][0], dims_fd3d_pml_kernel3[10][1], arg10);
        ACC<float> argp11(dims_fd3d_pml_kernel3[11][0], dims_fd3d_pml_kernel3[11][1], arg11);
        ACC<float> argp12(dims_fd3d_pml_kernel3[12][0], dims_fd3d_pml_kernel3[12][1], arg12);
        ACC<float> argp13(dims_fd3d_pml_kernel3[13][0], dims_fd3d_pml_kernel3[13][1], arg13);
        ACC<float> argp14(dims_fd3d_pml_kernel3[14][0], dims_fd3d_pml_kernel3[14][1], arg14);
        const ACC<float> argp15(dims_fd3d_pml_kernel3[15][0], dims_fd3d_pml_kernel3[15][1], arg15);
        const ACC<float> argp16(dims_fd3d_pml_kernel3[16][0], dims_fd3d_pml_kernel3[16][1], arg16);
        const ACC<float> argp17(dims_fd3d_pml_kernel3[17][0], dims_fd3d_pml_kernel3[17][1], arg17);
        const ACC<float> argp18(dims_fd3d_pml_kernel3[18][0], dims_fd3d_pml_kernel3[18][1], arg18);
        const ACC<float> argp19(dims_fd3d_pml_kernel3[19][0], dims_fd3d_pml_kernel3[19][1], arg19);
        const ACC<float> argp20(dims_fd3d_pml_kernel3[20][0], dims_fd3d_pml_kernel3[20][1], arg20);
        const ACC<float> argp21(dims_fd3d_pml_kernel3[21][0], dims_fd3d_pml_kernel3[21][1], arg21);
        const ACC<float> argp22(dims_fd3d_pml_kernel3[22][0], dims_fd3d_pml_kernel3[22][1], arg22);
        const ACC<float> argp23(dims_fd3d_pml_kernel3[23][0], dims_fd3d_pml_kernel3[23][1], arg23);
        const ACC<float> argp24(dims_fd3d_pml_kernel3[24][0], dims_fd3d_pml_kernel3[24][1], arg24);
        const ACC<float> argp25(dims_fd3d_pml_kernel3[25][0], dims_fd3d_pml_kernel3[25][1], arg25);
        const ACC<float> argp26(dims_fd3d_pml_kernel3[26][0], dims_fd3d_pml_kernel3[26][1], arg26);

        fd3d_pml_kernel3_gpu(&arg0, &arg1, &arg2, arg_idx, &arg4, &arg5, &arg6, argp7, argp8, argp9, argp10, argp11, argp12, argp13, argp14, argp15, argp16, argp17, argp18, argp19, argp20, argp21, argp22, argp23, argp24, argp25, argp26);
...
//  ==================
#ifndef OPS_LAZY
void ops_par_loop_fd3d_pml_kernel3(
    const char * name,
    ops_block block,
    int dim,
    int *range,
...
{ 
#else
void ops_par_loop_fd3d_pml_kernel3_execute(ops_kernel_descriptor *desc)
{
...
//  ======
    ...
    if (!ops_checkpointing_before(args, 27, range, 5)) return;
#endif

    if (block->instance->OPS_diags > 1)
    {
        ops_timing_realloc(block->instance, 5, "fd3d_pml_kernel3");
...
//  =================================================
    ...
    if (xdim7 != dims_fd3d_pml_kernel3_h[7][0] || ydim7 != dims_fd3d_pml_kernel3_h[7][1] || xdim8 != dims_fd3d_pml_kernel3_h[8][0] || ydim8 != dims_fd3d_pml_kernel3_h[8][1] || xdim9 != dims_fd3d_pml_kernel3_h[9][0] || ydim9 != dims_fd3d_pml_kernel3_h[9][1] || xdim10 != dims_fd3d_pml_kernel3_h[10][0] || ydim10 != dims_fd3d_pml_kernel3_h[10][1] || xdim11 != dims_fd3d_pml_kernel3_h[11][0] || ydim11 != dims_fd3d_pml_kernel3_h[11][1] || xdim12 != dims_fd3d_pml_kernel3_h[12][0] || ydim12 != dims_fd3d_pml_kernel3_h[12][1] || xdim13 != dims_fd3d_pml_kernel3_h[13][0] || ydim13 != dims_fd3d_pml_kernel3_h[13][1] || xdim14 != dims_fd3d_pml_kernel3_h[14][0] || ydim14 != dims_fd3d_pml_kernel3_h[14][1] || xdim15 != dims_fd3d_pml_kernel3_h[15][0] || ydim15 != dims_fd3d_pml_kernel3_h[15][1] || xdim16 != dims_fd3d_pml_kernel3_h[16][0] || ydim16 != dims_fd3d_pml_kernel3_h[16][1] || xdim17 != dims_fd3d_pml_kernel3_h[17][0] || ydim17 != dims_fd3d_pml_kernel3_h[17][1] || xdim18 != dims_fd3d_pml_kernel3_h[18][0] || ydim18 != dims_fd3d_pml_kernel3_h[18][1] || xdim19 != dims_fd3d_pml_kernel3_h[19][0] || ydim19 != dims_fd3d_pml_kernel3_h[19][1] || xdim20 != dims_fd3d_pml_kernel3_h[20][0] || ydim20 != dims_fd3d_pml_kernel3_h[20][1] || xdim21 != dims_fd3d_pml_kernel3_h[21][0] || ydim21 != dims_fd3d_pml_kernel3_h[21][1] || xdim22 != dims_fd3d_pml_kernel3_h[22][0] || ydim22 != dims_fd3d_pml_kernel3_h[22][1] || xdim23 != dims_fd3d_pml_kernel3_h[23][0] || ydim23 != dims_fd3d_pml_kernel3_h[23][1] || xdim24 != dims_fd3d_pml_kernel3_h[24][0] || ydim24 != dims_fd3d_pml_kernel3_h[24][1] || xdim25 != dims_fd3d_pml_kernel3_h[25][0] || ydim25 != dims_fd3d_pml_kernel3_h[25][1] || xdim26 != dims_fd3d_pml_kernel3_h[26][0] || ydim26 != dims_fd3d_pml_kernel3_h[26][1]) {
        dims_fd3d_pml_kernel3_h[7][0] = xdim7;
        dims_fd3d_pml_kernel3_h[7][1] = ydim7;
        dims_fd3d_pml_kernel3_h[8][0] = xdim8;
        dims_fd3d_pml_kernel3_h[8][1] = ydim8;
        dims_fd3d_pml_kernel3_h[9][0] = xdim9;
        dims_fd3d_pml_kernel3_h[9][1] = ydim9;
        dims_fd3d_pml_kernel3_h[10][0] = xdim10;
        dims_fd3d_pml_kernel3_h[10][1] = ydim10;
        dims_fd3d_pml_kernel3_h[11][0] = xdim11;
        dims_fd3d_pml_kernel3_h[11][1] = ydim11;
        dims_fd3d_pml_kernel3_h[12][0] = xdim12;
        dims_fd3d_pml_kernel3_h[12][1] = ydim12;
        dims_fd3d_pml_kernel3_h[13][0] = xdim13;
        dims_fd3d_pml_kernel3_h[13][1] = ydim13;
        dims_fd3d_pml_kernel3_h[14][0] = xdim14;
        dims_fd3d_pml_kernel3_h[14][1] = ydim14;
        dims_fd3d_pml_kernel3_h[15][0] = xdim15;
        dims_fd3d_pml_kernel3_h[15][1] = ydim15;
        dims_fd3d_pml_kernel3_h[16][0] = xdim16;
        dims_fd3d_pml_kernel3_h[16][1] = ydim16;
        dims_fd3d_pml_kernel3_h[17][0] = xdim17;
        dims_fd3d_pml_kernel3_h[17][1] = ydim17;
        dims_fd3d_pml_kernel3_h[18][0] = xdim18;
        dims_fd3d_pml_kernel3_h[18][1] = ydim18;
        dims_fd3d_pml_kernel3_h[19][0] = xdim19;
        dims_fd3d_pml_kernel3_h[19][1] = ydim19;
        dims_fd3d_pml_kernel3_h[20][0] = xdim20;
        dims_fd3d_pml_kernel3_h[20][1] = ydim20;
        dims_fd3d_pml_kernel3_h[21][0] = xdim21;
        dims_fd3d_pml_kernel3_h[21][1] = ydim21;
        dims_fd3d_pml_kernel3_h[22][0] = xdim22;
        dims_fd3d_pml_kernel3_h[22][1] = ydim22;
        dims_fd3d_pml_kernel3_h[23][0] = xdim23;
        dims_fd3d_pml_kernel3_h[23][1] = ydim23;
        dims_fd3d_pml_kernel3_h[24][0] = xdim24;
        dims_fd3d_pml_kernel3_h[24][1] = ydim24;
        dims_fd3d_pml_kernel3_h[25][0] = xdim25;
        dims_fd3d_pml_kernel3_h[25][1] = ydim25;
        dims_fd3d_pml_kernel3_h[26][0] = xdim26;
        dims_fd3d_pml_kernel3_h[26][1] = ydim26;

        cutilSafeCall(block->instance->ostream(), cudaMemcpyToSymbol( dims_fd3d_pml_kernel3, dims_fd3d_pml_kernel3_h, sizeof(dims_fd3d_pml_kernel3)));
    }
...
//      ====================
        ops_timers_core(&__c2, &__t2);
        block->instance->OPS_kernels[5].mpi_time += __t2 - __t1;
        block->instance->OPS_kernels[5].transfer += ops_compute_transfer(dim, start_indx, end_indx, &arg7);
        block->instance->OPS_kernels[5].transfer += ops_compute_transfer(dim, start_indx, end_indx, &arg8);
        block->instance->OPS_kernels[5].transfer += ops_compute_transfer(dim, start_indx, end_indx, &arg9);
        block->instance->OPS_kernels[5].transfer += ops_compute_transfer(dim, start_indx, end_indx, &arg10);
        block->instance->OPS_kernels[5].transfer += ops_compute_transfer(dim, start_indx, end_indx, &arg11);
        block->instance->OPS_kernels[5].transfer += ops_compute_transfer(dim, start_indx, end_indx, &arg12);
        block->instance->OPS_kernels[5].transfer += ops_compute_transfer(dim, start_indx, end_indx, &arg13);
        block->instance->OPS_kernels[5].transfer += ops_compute_transfer(dim, start_indx, end_indx, &arg14);
        block->instance->OPS_kernels[5].transfer += ops_compute_transfer(dim, start_indx, end_indx, &arg15);
        block->instance->OPS_kernels[5].transfer += ops_compute_transfer(dim, start_indx, end_indx, &arg16);
        block->instance->OPS_kernels[5].transfer += ops_compute_transfer(dim, start_indx, end_indx, &arg17);
        block->instance->OPS_kernels[5].transfer += ops_compute_transfer(dim, start_indx, end_indx, &arg18);
        block->instance->OPS_kernels[5].transfer += ops_compute_transfer(dim, start_indx, end_indx, &arg19);
        block->instance->OPS_kernels[5].transfer += ops_compute_transfer(dim, start_indx, end_indx, &arg20);
        block->instance->OPS_kernels[5].transfer += ops_compute_transfer(dim, start_indx, end_indx, &arg21);
        block->instance->OPS_kernels[5].transfer += ops_compute_transfer(dim, start_indx, end_indx, &arg22);
        block->instance->OPS_kernels[5].transfer += ops_compute_transfer(dim, start_indx, end_indx, &arg23);
        block->instance->OPS_kernels[5].transfer += ops_compute_transfer(dim, start_indx, end_indx, &arg24);
        block->instance->OPS_kernels[5].transfer += ops_compute_transfer(dim, start_indx, end_indx, &arg25);
        block->instance->OPS_kernels[5].transfer += ops_compute_transfer(dim, start_indx, end_indx, &arg26);
    }
}
    ...
    )
{
    ...
    create_kerneldesc_and_enque(name, "fd3d_pml_kernel3", args, 27, 5, dim, 1, range, block, ops_par_loop_fd3d_pml_kernel3_execute);
}
#endif
