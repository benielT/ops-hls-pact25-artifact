...
int bounds_2_l, int bounds_2_u) {
  ...
  if (n_0 < bounds_0_u && n_1 < bounds_1_u && n_2 < bounds_2_u) {
    ACC<double> u(dims_poisson_kernel_populate[1][0], dims_poisson_kernel_populate[1][1], u_p + n_0 + n_1 * dims_poisson_kernel_populate[1][0] + n_2 * dims_poisson_kernel_populate[1][0] * dims_poisson_kernel_populate[1][1]);
    ACC<double> f(dims_poisson_kernel_populate[2][0], dims_poisson_kernel_populate[2][1], f_p + n_0 + n_1 * dims_poisson_kernel_populate[2][0] + n_2 * dims_poisson_kernel_populate[2][0] * dims_poisson_kernel_populate[2][1]);
    ACC<double> ref(dims_poisson_kernel_populate[3][0], dims_poisson_kernel_populate[3][1], ref_p + n_0 + n_1 * dims_poisson_kernel_populate[3][0] + n_2 * dims_poisson_kernel_populate[3][0] * dims_poisson_kernel_populate[3][1]);
...
void ops_par_loop_poisson_kernel_populate_execute(const char *name, ops_block block, int blockidx_start, int blockidx_end, int dim, int *range, int nargs, ops_arg* args) {
  ...
  double * __restrict__ f_p = (double *)(args[2].data_d + args[2].dat->base_offset + blockidx_start * args[2].dat->batch_offset);

  double * __restrict__ ref_p = (double *)(args[3].data_d + args[3].dat->base_offset + blockidx_start * args[3].dat->batch_offset);
