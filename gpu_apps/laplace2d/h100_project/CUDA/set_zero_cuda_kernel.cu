...
//
__constant__ int dims_set_zero [1][3];
static int dims_set_zero_h [1][3] = {0};
...
int bounds_2_l, int bounds_2_u) {
  ...
  if (n_0 < bounds_0_u && n_1 < bounds_1_u && n_2 < bounds_2_u) {
    ACC<float> A(dims_set_zero[0][0], dims_set_zero[0][1], A_p + n_0 + n_1 * dims_set_zero[0][0] + n_2 * dims_set_zero[0][0] * dims_set_zero[0][1]);
...
#endif
#else
void ops_par_loop_set_zero_execute(const char *name, ops_block block, int blockidx_start, int blockidx_end, int dim, int *range, int nargs, ops_arg* args) {
  #ifdef OPS_BATCHED
  ...
  #endif
  if (args[0].dat->size[0] != dims_set_zero_h[0][0] || args[0].dat->size[1] != dims_set_zero_h[0][1] || args[0].dat->size[2] != dims_set_zero_h[0][2]) {
    dims_set_zero_h[0][0] = args[0].dat->size[0];
    dims_set_zero_h[0][1] = args[0].dat->size[1];
    dims_set_zero_h[0][2] = args[0].dat->size[2];
  ...
  if (x_size > 0 && y_size > 0)
    ops_set_zero<<<grid, tblock >>> (  A_p,         bounds_0_l, bounds_0_u, bounds_1_l, bounds_1_u,
