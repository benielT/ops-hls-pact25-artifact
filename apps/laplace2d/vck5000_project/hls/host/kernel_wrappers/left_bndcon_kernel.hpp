// Auto-generated at 2025-07-29 02:44:01.723788 by ops-translator
#pragma once 
#include <ops_hls_rt_support.h>

void inline kernel_left_bndcon_core(
        float& arg0_0,
        const int * idx
)
{

  arg0_0 = sin(pi * (idx[1]+1) / (jmax+1));

}

void ops_par_loop_left_bndcon(ops::hls::Block dummyBlock, int dim, int* ops_range,
