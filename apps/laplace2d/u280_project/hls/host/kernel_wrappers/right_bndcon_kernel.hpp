// Auto-generated at 2025-07-28 20:05:38.620611 by ops-translator
#pragma once 
#include <ops_hls_rt_support.h>

void inline kernel_right_bndcon_core(
        float& arg0_0,
        const int * idx
)
{

  arg0_0 = sin(pi * (idx[1]+1) / (jmax+1))*exp(-pi);

}

void ops_par_loop_right_bndcon(ops::hls::Block dummyBlock, int dim, int* ops_range,
