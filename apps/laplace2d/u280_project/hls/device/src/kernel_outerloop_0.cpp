// Auto-generated at 2025-07-28 20:05:39.025599 by ops-translator
...
{
    ::hls::stream<ap_uint<axis_data_width>> node2_1_to_node3_1;
    #pragma HLS STREAM variable = node2_1_to_node3_1 depth = 10

    kernel_apply_stencil_PE(PEId, stencilConfig,
            arg0_hls_stream_in,
            arg1_hls_stream_out
    );
}
...
#pragma HLS DATAFLOW
::hls::stream<ap_uint<axis_data_width>> arg0_arg1_streams[iter_par_factor + 1];
    #pragma HLS STREAM variable = arg0_arg1_streams depth = 50
